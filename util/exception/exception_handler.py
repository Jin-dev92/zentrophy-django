...
exception_handler_list = [
    ...
    {
        'data': {
            'message': USER_NOT_ACCESS_DENIED,
            'status_code': '2'
        },
    ...
    {
        'data': {
            'message': CANT_SALE_STOCK_COUNT_IS_ZERO,
            'status_code': '4'
        },
    ...
    {
        'data': {
            'message': DISPLAY_LINE_DONT_EXCEEDED_SIZE,
            'status_code': '5'
        },
    ...
    {
        'data': {
            'message': CANT_CHANGE_ORDER_STATE,
            'status_code': '6'
        },
    ...
    {
        'data': {
            'message': REFUSE_MUST_HAVE_REASON,
            'status_code': '7'
        },
